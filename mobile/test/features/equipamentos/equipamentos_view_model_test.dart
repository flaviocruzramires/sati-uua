...
void main() {
  ...
  setUp(() {
    ...
    when(() => tipoRepo.combo()).thenAnswer((_) async => [
  ...
  test('create retorna true', () async {
    ...
    final c = makeContainer();
    addTearDown(c.dispose);
    final ok = await c.read(equipamentosViewModelProvider.notifier).create(
          descricao: 'Notebook Dell',
          tipoEquipamentoId: 1,
        );
    expect(ok, isTrue);
  ...
  test('update retorna true', () async {
    ...
    final c = makeContainer();
    addTearDown(c.dispose);
    final ok = await c.read(equipamentosViewModelProvider.notifier).update(
          id: 1,
          descricao: 'Notebook Dell',
          tipoEquipamentoId: 1,
          ativo: true,
