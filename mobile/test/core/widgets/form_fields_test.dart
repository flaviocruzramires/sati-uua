...
void main() {
  group('AppTextField', () {
    testWidgets('renderiza label e campo', (tester) async {
      await tester.pumpWidget(
        _wrap(AppTextField(label: 'Nome', controller: TextEditingController())),
      );
  ...
  group('AppDateField', () {
    testWidgets('renderiza label e exibe data formatada', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(AppDateField(label: 'Data', value: date, onChanged: (_) {})),
      );
    ...
    testWidgets('campo sem valor não mostra texto de data', (tester) async {
      await tester.pumpWidget(
        _wrap(AppDateField(label: 'Data', value: null, onChanged: (_) {})),
      );
  ...
  group('AppDateTimeField', () {
    testWidgets('renderiza label e data+hora formatados', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(
          AppDateTimeField(label: 'Data e hora', value: dt, onChanged: (_) {}),
        ),
      );
